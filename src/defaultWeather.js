...
const defaultData = () => {
  ...
  fetch(url, {
    ...
    .then((data) => {
      ...
      document.getElementById('wind-item').innerHTML = `<p class="font-weight-bold text-center" id="windText">wind</p>
      <p class="font-weight-bold text-center" id="windValue">${data.wind.speed} mph</p>`;
